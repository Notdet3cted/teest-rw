...
<body>
            ...
            <div class="col-md-4 col-sm-12 shadow-lg p-5 text-white" style="border-radius: 20px; background-color: #2c3e50;">
                <div class="text-center">
                    ...
                    <div style="display: none;" class="alert alert-danger" id="alert" role="alert">
                        <strong>Perhatian!</strong> Silahkan Lengkapi dan isi formulir dengan benar.
                    </div>
                </div>

                <?= form_open(site_url("auth/proses_register")) ?>
                <!-- Email  -->
                ...
                <div class="form-group has-error mb-3">
                    <div class="row">
                        ...
                        <div class="col d-flex justify-content-end">
                            <button type="button" class="btn" style="color: white;" onclick="show_conf()"><i id="icon_conf" class="bi bi-eye-fill"></i></button>
                        </div>
                    </div>
                    <?php
                    $data = array(
                        ...
                        'required' => TRUE,
                        'class' => form_error('password_confirmation') ? 'form-control is-invalid' : 'form-control',
                ...
                <!-- Submit button -->
                <div class="col d-flex justify-content-end">
                    <button type="submit" onclick="sub()" class="btn btn-lg mb-4 text-white" style="background-color: #d35400;">Register</button>
                </div>
                </form>

                <div class="text-center">
                    <p class="mt-4">Sudah Punya Akun? <a style="color:#d35400;" href="<?= site_url("auth/login") ?>">Login</a></p>
                </div>
            </div>
    ...
    <script>
        ...
        var password_conf = document.getElementById("password_confirmation");
        ...
        var icon_conf = document.getElementById("icon_conf")
        ...
        function show_conf() {
            if (password_conf.type === "password") {
                icon_conf.classList.remove('bi-eye-fill')
                icon_conf.classList.add('bi-eye-slash-fill')
                password_conf.type = "text"
            } else {
                icon_conf.classList.add('bi-eye-fill')
                icon_conf.classList.remove('bi-eye-slash-fill')
